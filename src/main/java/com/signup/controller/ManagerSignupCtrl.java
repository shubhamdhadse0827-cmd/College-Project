...
@WebServlet("/ManagerSignupCtrl")
@MultipartConfig
public class ManagerSignupCtrl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int i = model.managerSignUp(name, email, pwd, contact_no, aadhaar_no, photo, building_name);
